                ...
                t.each(this.split(","), function(r, i) {
                    if ("title" == i)
                        ...
                        if (e[i] ? s = e[i] : Re[i] && (s = function() {
                            ...
                            l = v ? _(v) : c && n.theme ? "<span class='ui-icon ui-icon-" + c + "'></span>" : d && !n.theme ? "<span class='" + d + "'></span>" : _(u || i);
                            var h = t("<span class='btn btn-primary fcc-button fc-button-" + i + " " + f + "-state-default'>" + l + "</span>").click(function() {
