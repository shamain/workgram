...
class Notified_users_controller extends CI_Controller {
    ...
    /*
     * loads notified users table view
     */
    ...
    /*Update Notified user
     * inputs employee_code, notification_id and notified_users_id
    ...
    /*Add New Notified user
     * inputs employee_code and notification_id
     * returns 1 if success
     */
    ...
    function mark_notified_user_as_seen($notified_users_id) {
        ...
        echo $notified_users_service->mark_notified_user_as_seen($notified_users_id);
    }

    /*
     * returns Employee's unseen notification count
     */
