...
<head>
    ...
    <link href="<?php echo base_url(); ?>application_resources/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>application_resources/plugins/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css" />
...
<body class="error-body no-top">
            ...
            <div class="error-main">
                ...
                <div class="row-fluid">
                    <div class="input-with-icon span12">                                       
                        ...
                        <input type="text" class="span12" id="form1Name" name="form1Name" />                                 
                    </div>
                </div>
                <br />
    ...
    <div id="footer">
        <div class="span12 error-container">
            ...
            <br />
            <div class="copyright">
                All work copyright of respective owner, 2013 workgram Incorporated
            </div>
