...
class employee_payment_service extends CI_Model {
    ...
    public function get_employee_payment($employee_payment_model) {
        ...
        $query = $this->db->get_where('employee_payment', array('company_code' => $employee_payment_model->get_company_code(),'employee_code' => $employee_payment_model->get_employee_code(),'year_month'=>$employee_payment_model->get_year_month()));
        return $query->row();
